                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><p><?php echo ucfirst($row["vec_brand"]);?></p></td>
                                <td><p><?php echo ucfirst($row["vec_model"]);?></p></td>
                                <td><p><?php echo ucfirst($row["vec_part"]);?></p></td>
                                <td><p><?php echo ucfirst($row["shop"]);?></p></td>
                                <td><p>Rs.<?php echo $row["price"];?></p></td>
                                <td><p><?php echo ucfirst($row["pstatus"]);?></p></td>
                                <td class="actions">
                                <div><a href="partsupdate.php?id=<?php echo $row["vec_id"];?>" class="btn btn-primary mb-1 btn-sm" onclick='return confirm("Are you sure you want to update?");'>edit</a></div>
                                <div><a href="include/deleteparts.inc.php?id=<?php echo $row["vec_id"];?>" class="btn btn-danger mt-1 btn-sm" onclick='return confirm("Are you sure you want to delete?");'>delete</a></div>
                                </td>
                            </tr>
                        <?php 
                        } 
