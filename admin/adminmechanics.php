                ...
                <table id="mechanictable" class="table table-striped mechtable" style="overflow-x: auto;" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                            <td>
                                <img src="../<?php echo $row["mechanic_img"];?>" height="50px" width="50px">
                            </td>
                            <td>
                            ...
                            <td class="actions">
                                <div><a href="mechupdate.php?id=<?php echo $row["mechanic_id"];?>" class="btn btn-primary btn-sm mb-1" onclick='return confirm("Are you sure you want to update this account?");'>edit</a></div>
                                <div><a href="include/deletemech.inc.php?id=<?php echo $row["mechanic_id"];?>" class="btn btn-danger btn-sm mt-1" onclick='return confirm("Are you sure you want to delete this account?");'>delete</a></div>
                            </td>
                        </tr>
                        <?php 
                        } 
